                        ...
                        <div className=" w:60% position-relative">
                            <div className=" align">
                                <div className="input-group p-0 d-flex flex-row align-items-center">
                                    ...
                                    <div className="w-40 border-0 m-0 p-0 shadow-lg bg-white rtl:5">
                                    ...
                                    <div className="w-40 border-0 m-0 p-0 bg-white rounded-start">
                        ...
                        <ul className="navbar-nav w:40% me-auto mb-2 mb-lg-0 d-flex flex-md-row justify-content-md-end ms-md-4">
                            ...
                            <li className="nav-item">
                                <Stack direction="row" spacing={2}>
                                    <Button variant="outlined" sx={{ color: "white", border: "solid white 2px" }} href={`login`}>Log In</Button>
                                    <Button variant="contained" sx={{ color: "white", backgroundColor: "rgb(244, 13, 21)" }} href={`signup`}>Sign Up</Button>
                                </Stack>
                            </li>
                        </ul>
